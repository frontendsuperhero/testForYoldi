...
//   const token = typeof window !== 'undefined' ? localStorage.getItem('X-API-KEY') : '';
...
export default function Profile() {
  ...
  return (
    ...
    >
      {!isLoading && !profile ? (
        <div className="non-authorized-user">
          <div>
            <Link href="/auth/sign-in">Войдите</Link> или <Link href="/auth/sign-up">зарегистрируйтесь</Link>, чтобы продолжить...
          </div>
        </div>
      ) : (
